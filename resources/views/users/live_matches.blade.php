...
<div class="container-cricket active mt-4">
    <div class="services__main d-flex flex-wrap justify-content-start" id="cricket-container">
        @foreach ($liveCricket as $index => $cricket)
            <div class="services-box border p-3 cricket-item" style="box-shadow: rgba(100, 100, 111, 0.2) 0px 4px 15px 0px; display: {{ $index < 4 ? 'block' : 'none' }};">
                <a href="" class=" text-black mb-2 w-full block text-center" style="font-size: 12px; line-height: 20px;">{{$cricket['Name']}}</a>
                <hr class="mb-1">
                <div class="match-container">
                    <iframe src="https://live.oldd247.com/sr.php?eventid={{$cricket['MatchID']}}" width="200" height="100" style="border: 1px solid #ccc;" allowfullscreen></iframe>
                    <div class="live-button-container">
                        <a href="{{ Auth::check() ? route('live.stream', ['eventId' => $cricket['MatchID'], 'sportId' => 4, 'channelId' => $cricket['Channel']]) : '#' }}" onclick="checkLogin(event)">
...
<div class="container-tennis mt-4">
    <div class="services__main d-flex flex-wrap justify-content-start" id="tennis-container">
        @foreach ($liveTennis as $index => $tennis)
            <div class="services-box border p-3 tennis-item" style="box-shadow: rgba(100, 100, 111, 0.2) 0px 4px 15px 0px; display: {{ $index < 4 ? 'block' : 'none' }};">
                <a href="" class=" text-black mb-2 w-full block text-center" style="font-size: 12px; line-height: 20px;">{{$tennis['Name']}}</a>
                <hr class="mb-1">
                <div class="match-container">
                    <iframe src="https://live.oldd247.com/sr.php?eventid={{$tennis['MatchID']}}" width="200" height="100" style="border: 1px solid #ccc;" allowfullscreen></iframe>
                    <div class="live-button-container">
                        <a href="{{ Auth::check() ? route('live.stream', ['eventId' => $tennis['MatchID'], 'sportId' => 2, 'channelId' => $tennis['Channel']]) : '#' }}" onclick="checkLogin(event)">
                            <button type="submit" class="btn-action btn-live">Live Match</button>
                        </a>
                    </div>
                </div>
...
<div class="container-football mt-4">
    <div class="services__main d-flex flex-wrap justify-content-start" id="football-container">
        @foreach ($liveFootball as $index => $football)
            <div class="services-box border p-3 football-item" style="box-shadow: rgba(100, 100, 111, 0.2) 0px 4px 15px 0px; display: {{ $index < 4 ? 'block' : 'none' }};">
                <a href="" class=" text-black mb-2 w-full block text-center" style="font-size: 12px; line-height: 20px;">{{$football['Name']}}</a>
                <hr class="mb-1">
                <div class="match-container">
                    <iframe src="https://live.oldd247.com/sr.php?eventid={{$football['MatchID']}}" width="200" height="100" style="border: 1px solid #ccc;" allowfullscreen></iframe>
                    <div class="live-button-container">
                        <a href="{{ Auth::check() ? route('live.stream', ['eventId' => $football['MatchID'], 'sportId' => 1, 'channelId' => $football['Channel']]) : '#' }}" onclick="checkLogin(event)">
                            <button type="submit" class="btn-action btn-live">Live Match</button>
                        </a>
                    </div>
                </div>
