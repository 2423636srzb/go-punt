                                ...
                                <tbody>
                                   @foreach ($accounts as $account)
                                    ...
                                    <tr>
                                        ...
                                        <td>{{setCurrency(1000)}}</td>
                                        <td class="text-center">
                                            <span
                                                class="bg-success-focus text-success-main px-24 py-4 rounded-pill fw-medium text-sm">{{$account->status}}</span>
                                        </td>
                                    </tr>
                                    @endforeach
                                </tbody>
