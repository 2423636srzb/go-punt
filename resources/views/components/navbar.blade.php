            ...
            --><!-- Message dropdown end -->
                {{-- <div class="dropdown">
                    ...
                    <div class="dropdown-menu to-top dropdown-menu-lg p-0">
                        <div
                            ...
                            <span
                                class="text-primary-600 fw-semibold text-lg w-40-px h-40-px rounded-circle bg-base d-flex justify-content-center align-items-center">{{ Auth::user()->unreadNotifications->count() }}</span>
                        </div>
                ...
                <div class="dropdown">
                    <button class="d-flex justify-content-center align-items-center rounded-circle" type="button"
                        ...
                        @endphp
                        <img src="{{ $image }}" alt="image" class="w-40-px h-40-px object-fit-cover rounded-circle">
                    </button>
                    <div class="dropdown-menu to-top dropdown-menu-sm">
                        <div
                            ...
                            <div>
                                ...
                                <span class="text-secondary-light fw-medium text-sm">@if(Auth::user()->is_admin) Admin
                                    @else User @endif</span>
                            </div>
