...
<body class="bg-white">
    ...
    <div class="container mx-auto mt-4 overflow-hidden relative">
        <div class="relative">
            ...
            <div id="slider" class="flex transition-transform duration-500 ease-in-out">
                ...
                <img src="{{ url('assets/images/BD/banner1.jpg') }}" alt="Game Slider Image" class="ml-2 w-full h-64 object-cover">
                <img src="{{ url('assets/images/BD/banner2.jpg') }}" alt="Game Slider Image" class="ml-2 w-full h-64 object-cover">
              
            </div>
           
    
            <!-- Navigation Buttons -->
            <button id="prevBtn" class="absolute left-0 top-1/2 transform -translate-y-1/2 text-white text-2xl bg-black p-2 opacity-50 hover:opacity-100">
                &#10094;
            </button>
            <button id="nextBtn" class="absolute right-0 top-1/2 transform -translate-y-1/2 text-white text-2xl bg-black p-2 opacity-50 hover:opacity-100">
                &#10095;
            </button>
        </div>
    </div>
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // Function to update the transform to show the correct slide
            function updateSlider() {
                const offset = -currentIndex * 100; // Slide width
