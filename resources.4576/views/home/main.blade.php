...
<body class="bg-white">
    ...
    <div class="bg-red-600 text-white text-center py-2">
        <div class="overflow-hidden h-6">
            <div class="rotating-text">
                <div>New Game Release: Adventure Quest!</div>
                <div>50% off on selected games!</div>
                <div>Join our community forum now!</div>
                <div>Check out our latest blog post!</div>
            </div>
        </div>
    </div>
    ...
    <nav class="bg-white shadow-md">
        <div class="container mx-auto px-4 py-3 flex justify-between items-center">
            <div class="flex items-center">
                <img src="{{ asset('assets/images/logo-dark.png') }}" alt="Logo Dark" class="mr-3" width="180">
            </div>
            ...
            <div id="user-profile" class="hidden flex items-center space-x-4" style="cursor: pointer;"
                ...
                @php
                if(Auth::check()){
                $image = asset('storage/profile_images/')."/".Auth::user()->profile_image;
                }else{
    ...
    <div class="container mx-auto mt-4 overflow-hidden relative">
        <div class="flex transition-transform duration-500 ease-in-out">
            <img src="https://placehold.co/800x300?text=Game+1" alt="Game Slider Image 1"
                class="w-full h-64 object-cover">
            <img src="https://placehold.co/800x300?text=Game+2" alt="Game Slider Image 2"
                class="w-full h-64 object-cover">
            <img src="https://placehold.co/800x300?text=Game+3" alt="Game Slider Image 3"
                class="w-full h-64 object-cover">
        </div>
    </div>
    ...
    <div class="container mx-auto mt-8 grid grid-cols-2 md:grid-cols-4 gap-4">
        ...
        <div class="bg-white p-4 shadow-md rounded game-item transition-transform duration-300">
            <img src="https://placehold.co/150x150" alt="Game 1 Logo"
                class="mx-auto mb-2 rounded-lg transition-transform duration-300">
            <h3 class="text-center text-lg font-semibold text-black">Game Title 1</h3>
            <button
        ...
        <!-- Game Item 2 -->
        <div class="bg-white p-4 shadow-md rounded game-item transition-transform duration-300">
            <img src="https://placehold.co/150x150" alt="Game 2 Logo"
                class="mx-auto mb-2 rounded-lg transition-transform duration-300">
            <h3 class="text-center text-lg font-semibold text-black">Game Title 2</h3>
            <button
                class="mt-2 bg-red-500 text-white px-4 py-2 rounded-full block mx-auto transition-all duration-300">View
                Login</button>
        </div>
        <!-- Game Item 3 -->
        <div class="bg-white p-4 shadow-md rounded game-item transition-transform duration-300">
            <img src="https://placehold.co/150x150" alt="Game 3 Logo"
                class="mx-auto mb-2 rounded-lg transition-transform duration-300">
            <h3 class="text-center text-lg font-semibold text-black">Game Title 3</h3>
            <button
                class="mt-2 bg-red-500 text-white px-4 py-2 rounded-full block mx-auto transition-all duration-300">View
                Login</button>
        </div>
        <!-- Game Item 4 -->
        <div class="bg-white p-4 shadow-md rounded game-item transition-transform duration-300">
            <img src="https://placehold.co/150x150" alt="Game 4 Logo"
                class="mx-auto mb-2 rounded-lg transition-transform duration-300">
            <h3 class="text-center text-lg font-semibold text-black">Game Title 4</h3>
            <button
                class="mt-2 bg-red-500 text-white px-4 py-2 rounded-full block mx-auto transition-all duration-300">View
                Login</button>
        </div>
        <!-- Game Item 5 -->
        <div class="bg-white p-4 shadow-md rounded game-item transition-transform duration-300">
            <img src="https://placehold.co/150x150" alt="Game 5 Logo"
                class="mx-auto mb-2 rounded-lg transition-transform duration-300">
            <h3 class="text-center text-lg font-semibold text-black">Game Title 5</h3>
            <button
                class="mt-2 bg-red-500 text-white px-4 py-2 rounded-full block mx-auto transition-all duration-300">View
                Login</button>
        </div>
        <!-- Game Item 6 -->
        <div class="bg-white p-4 shadow-md rounded game-item transition-transform duration-300">
            <img src="https://placehold.co/150x150" alt="Game 6 Logo"
                class="mx-auto mb-2 rounded-lg transition-transform duration-300">
            <h3 class="text-center text-lg font-semibold text-black">Game Title 6</h3>
            <button
                class="mt-2 bg-red-500 text-white px-4 py-2 rounded-full block mx-auto transition-all duration-300">View
                Login</button>
        </div>
        <!-- Game Item 7 -->
        <div class="bg-white p-4 shadow-md rounded game-item transition-transform duration-300">
            <img src="https://placehold.co/150x150" alt="Game 7 Logo"
                class="mx-auto mb-2 rounded-lg transition-transform duration-300">
            <h3 class="text-center text-lg font-semibold text-black">Game Title 7</h3>
            <button
                class="mt-2 bg-red-500 text-white px-4 py-2 rounded-full block mx-auto transition-all duration-300">View
                Login</button>
        </div>
        <!-- Game Item 8 -->
        <div class="bg-white p-4 shadow-md rounded game-item transition-transform duration-300">
            <img src="https://placehold.co/150x150" alt="Game 8 Logo"
                class="mx-auto mb-2 rounded-lg transition-transform duration-300">
            <h3 class="text-center text-lg font-semibold text-black">Game Title 8</h3>
            <button
                class="mt-2 bg-red-500 text-white px-4 py-2 rounded-full block mx-auto transition-all duration-300">View
                Login</button>
        </div>
