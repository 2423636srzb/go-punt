    ...
    <div class="container">
      <div class="flex gap-10">
          ...
          <!-- Right Side: Video Player (Live Stream) -->
              ...
              <iframe width="100%" src="https://live.oldd247.com/sr.php?eventid={{$eventId}}sportid={{$sportId}}" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"  allowfullscreen></iframe>
    ...
    <div class="flex gap-10">
        ...
        <!-- Right Side: Video Player (Live Stream) -->
          <div style="min-height: 350px; width: 100%;">
            <!-- Embed the live stream using iframe -->
            <iframe width="100%" height="100%" src="https://live.oldd247.com/sr.php?eventid={{$eventId}}sportid={{$sportId}}" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
          </div>
    </div>
</div>
...
<div class="container">
  <div class="flex gap-10">
      ...
      <div style="min-height: 350px; background-color: #007bff; width: 100%;">
          <!-- Embed the live stream using iframe -->
          <iframe width="100%" height="100%" src="https://live.oldd247.com/sr.php?eventid={{$eventId}}sportid={{$sportId}}" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"  allowfullscreen></iframe>
      </div>
  </div>
</div>
@endif
