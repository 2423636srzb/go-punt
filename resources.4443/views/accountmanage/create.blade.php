                ...
                <div class="card-body">
                    <form class="row gy-3 needs-validation" action="{{ route('games.store') }}" method="POST" enctype="multipart/form-data" novalidate>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="url" name="login_link" id="login_link" class="form-control" placeholder="Enter Account Link" required>
                            <div class="invalid-feedback">
                        ...
                        <div class="col-md-6">
                            <label class="form-label">Status</label>
                                ...
                                <div class="invalid-feedback">
                                    Please select the Accunt status.
                                </div>
                        </div>

                        
                        <div class="col-12">
                            <button class="btn btn-primary-600" type="submit">Create Accunt</button>
                        </div>
                    </form>
                </div>
            </div>
