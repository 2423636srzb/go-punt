            ...
            <div class="card-body p-20">
                ...
                <p class="fw-medium text-sm text-primary-light mt-12 mb-0 d-flex align-items-center gap-2">
                    <span class="d-inline-flex align-items-center gap-1 text-success-main">
                        <!-- <iconify-icon icon="bxs:up-arrow" class="text-xs"></iconify-icon> --> {{ setCurrency(1500);
                        }}
                    </span>
                    Last Transaction
                </p>
            ...
            <div class="card-body p-20">
                <div class="d-flex flex-wrap align-items-center justify-content-between gap-3">
                    <div>
                        ...
                        <h6 class="mb-0">{{ setCurrency(40000) }}</h6>
                    </div>
                    <div
            ...
            <div class="card-body p-20">
                <div class="d-flex flex-wrap align-items-center justify-content-between gap-3">
                    <div>
                        ...
                        <h6 class="mb-0">{{ setCurrency(30000); }}</h6>
                    </div>
                                            ...
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div class="flex-grow-1">
                                                    ...
                                                    <span class="text-sm text-secondary-light fw-medium"><a
                                                            href="https://bmw.com/"
                                                            target="_blank">https://bmw.com/</a></span>
                                                </div>
                                            </div>
                                        </td>
                                        <td>
            ...
            <div class="card-body">
                ...
                <div class="mt-32">
                    ...
                    <div class="d-flex align-items-center justify-content-between gap-3 mb-24">
                        ...
                        <span class="text-primary-light text-md fw-medium">{{setCurrency(20)}}</span>
                    </div>
