            ...
            <div class="card-body p-20">
                <div class="d-flex flex-wrap align-items-center justify-content-between gap-3">
                    <div>
                        ...
                        <h6 class="mb-0">{{setCurrency(20000)}}</h6>
                    </div>
            ...
            <div class="card-body p-20">
                <div class="d-flex flex-wrap align-items-center justify-content-between gap-3">
                    <div>
                        ...
                        <h6 class="mb-0">{{setCurrency(5000)}}</h6>
                    </div>
                    <div
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex align-items-center">
                                        <img src="@if($game->logo){{asset('storage/'.$game->logo)}}@else{{asset('assets/images/users/user1.png')}}@endif"
                                            alt=""
            ...
            <div class="card-body">
                ...
                <div class="mt-32">
                    <div class="d-flex align-items-center justify-content-between gap-3 mb-24">
                        ...
                        <span class="text-primary-light text-md fw-medium">{{setCurrency(30)}}</span>
                    </div>
                    ...
                    <div class="d-flex align-items-center justify-content-between gap-3 mb-24">
                        <div class="d-flex align-items-center">
                            ...
                            <div class="flex-grow-1">
                                <h6 class="text-md mb-0 fw-medium">BMW</h6>
                                <span class="text-sm text-secondary-light fw-medium">Status: <span
                                        class="text-danger">Declined</span></span>
                            </div>
                        </div>
                        <span class="text-primary-light text-md fw-medium">{{setCurrency(80)}}</span>
                    </div>
                    ...
                    <div class="d-flex align-items-center justify-content-between gap-3 mb-24">
                        <div class="d-flex align-items-center">
                            ...
                            <div class="flex-grow-1">
                                <h6 class="text-md mb-0 fw-medium">BMW</h6>
                                <span class="text-sm text-secondary-light fw-medium">Status: <span
                                        class="text-success">Paid</span></span>
                            </div>
                        </div>
                        <span class="text-primary-light text-md fw-medium">{{setCurrency(30)}}</span>
                    </div>
                    ...
                    <div class="d-flex align-items-center justify-content-between gap-3 mb-24">
                        ...
                        <span class="text-primary-light text-md fw-medium">{{setCurrency(50)}}</span>
                    </div>
                    ...
                    <div class="d-flex align-items-center justify-content-between gap-3 mb-24">
                        ...
                        <span class="text-primary-light text-md fw-medium">{{setCurrency(40)}}</span>
                    </div>
                    ...
                    <div class="d-flex align-items-center justify-content-between gap-3 mb-24">
                        ...
                        <span class="text-primary-light text-md fw-medium">{{setCurrency(90)}}</span>
                    </div>
