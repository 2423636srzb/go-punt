...
{  Log::info($request->all());
    ...
    public function adminBankEdit($id)
    {
        $bankAccount = AdminBankAccount::find($id);
...
{  
    ...
    try {
        // Find the existing payment record
        $paymentRecord = AdminBankAccount::findOrFail($id);
    ...
    public function adminBankStore(Request $request)
    {
        ...
        // $imagePath = $request->file('file')->store('transactions', 'public');
            ...
            // Save the data in the database
            $paymentRecord = AdminBankAccount::create($paymentData);
